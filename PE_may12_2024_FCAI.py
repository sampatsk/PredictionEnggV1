...
def column_selection_task_selection(csv_dataset): 
    ...
    elif 'FUJITSU_CHATAI_ENDPOINT' not in os.environ or 'FUJITSU_CHATAI_KEY' not in os.environ: 
    ...
    elif 'FUJITSU_CHATAI_ENDPOINT' in os.environ and 'FUJITSU_CHATAI_KEY' in os.environ:
        input_column_names = []
        colmap = {}
        for c in colnames:
...
def main():
    ...
    with open('results_may12_FCAI.csv', 'a+') as csvfile:
