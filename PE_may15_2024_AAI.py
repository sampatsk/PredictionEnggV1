...
def column_selection_task_selection(csv_dataset): 
    ...
    if len(colnames)>10000:
        ...
        recommended_target_columns = ["Env var error","Env var error","Env var error"]
        recommended_ml_task = ""
        return recommended_target_columns, recommended_ml_task
...
def main():
    ...
    with open('results_may15_AAI.csv', 'a+') as csvfile:
